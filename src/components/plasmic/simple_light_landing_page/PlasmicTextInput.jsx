...
import * as sty from "./PlasmicTextInput.module.css" // plasmic-import: b3qlW9uwOgyh2F/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg" // plasmic-import: XdX73wBB1c6iNP/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg" // plasmic-import: moBk4aZ92CkvuU/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__zDl77)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hLken)}
                role={"img"}
              />
            ),
