...
import * as sty from "./PlasmicFeatureCard.module.css" // plasmic-import: kFrA-f5VBPDSC/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___8EaKb, {
            [sty.freeBoxlong___8EaKb6PDya]: hasVariant(
              variants,
              "long",
              "long"
            ),
        ...
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__u8CI, {
              [sty.freeBoxlong__u8CI6PDya]: hasVariant(
                variants,
                "long",
                "long"
              ),
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg__wops9)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__g6D99, {
          [sty.freeBoxlong__g6D996PDya]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__kyHso, {
            [sty.freeBoxlong__kyHso6PDya]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ioIlr)}
                role={"img"}
              />
            ),
