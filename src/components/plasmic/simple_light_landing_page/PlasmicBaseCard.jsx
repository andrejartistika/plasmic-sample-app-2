...
import * as sty from "./PlasmicBaseCard.module.css" // plasmic-import: qULBi6g-dGjN7c/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___6O6WL, {
          [sty.freeBoxlong___6O6WL3P4Hl]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__q3E1B, {
            [sty.freeBoxlong__q3E1B3P4Hl]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__cIz5)}
                role={"img"}
              />
            ),
