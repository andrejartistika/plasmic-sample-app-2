...
import * as sty from "./PlasmicFaq.module.css" // plasmic-import: UckwIHawiT53G5/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hrjAg)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__prJzI)}>
          <div className={classNames(projectcss.all, sty.freeBox___2VbYi)}>
            {p.renderPlasmicSlot({
