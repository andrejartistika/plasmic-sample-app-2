...
import * as sty from "./PlasmicHomeCta.module.css" // plasmic-import: dwH0g104UcEek/css
import SphereIcon from "./icons/PlasmicIcon__Sphere" // plasmic-import: 639mrxdJHG7SOD/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xolpo)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__yPsV)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__hm5W3)}>
          <SphereIcon
